...
export class MockGoogleDriveAdapter {
  ...
  initDefaultCourseSheets() {
    // 1. solar Leads (Standard Meta Ads format)
    this.addMockSheet('sheet_solar_001', 'solar Leads', [
      ['Meta Lead ID', 'Full Name', 'Phone Number', 'Email Address', 'Campaign Name', 'Ad Set Name', 'Ad Name', 'City', 'Created Time'],
      ['meta_solar_101', 'Aarav Mehta', '+91 98111 22334', 'aarav.solar@gmail.com', 'solar Pilot Admission 2026', 'Delhi NCR Aspirants', 'Flight Simulator Video Ad', 'Delhi', '2026-08-20T10:30:00Z'],
      ['meta_solar_102', 'Rohan Verma', '9822233445', 'rohan.pilot@yahoo.com', 'solar Pilot Admission 2026', 'Mumbai Aviation Youth', 'Cockpit View Carousel', 'Mumbai', '2026-08-21T11:15:00Z'],
      ['meta_solar_103', 'Kabir Singh', '+91 98333 44556', 'kabir.singh@gmail.com', 'solar Pilot Admission 2026', 'Punjab Flying Club', 'DGCA Ground Class Ad', 'Chandigarh', '2026-08-22T09:00:00Z']
    ]);
    ...
    // 3. YCMOU Leads
    this.addMockSheet('sheet_cabin_003', 'YCMOU Leads', [
      ['FB Lead ID', 'Customer Name', 'Mobile Number', 'Email Address', 'Campaign Name', 'City', 'Age', 'Timestamp'],
      ['meta_cc_301', 'Ananya Sharma', '+91 98666 77889', 'ananya.cc@gmail.com', 'YCMOU Glamour Batch', 'Jaipur', '21', '2026-08-22T12:00:00Z'],
      ['meta_cc_302', 'Pooja Hegde', '+91 98777 88990', 'pooja.hegde@hotmail.com', 'YCMOU International 2026', 'Pune', '22', '2026-08-23T15:30:00Z'],
      ['meta_cc_303', 'Rhea Chakraborty', '9888899001', 'rhea.crew@gmail.com', 'Ground Staff Training', 'Kolkata', '20', '2026-08-24T08:10:00Z']
    ]);

    // 4. Maintenance Engineering Leads
